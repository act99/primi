import 'package:primi/screens/two_choose_screen.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:url_launcher/url_launcher.dart';

class TwoPhotoScreen extends StatefulWidget {
  final bool gender;
  TwoPhotoScreen({this.gender});
  @override
  _TwoPhotoScreenState createState() => _TwoPhotoScreenState();
}

class _TwoPhotoScreenState extends State<TwoPhotoScreen> {
  _launchURL() async {
          ...
          child: Center(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                height: width * 0.5,
                child: widget.gender
                    ? Image.asset('assets/2photofemale.png')
                    : Image.asset('assets/2photomale.png'),
              ),
              Text(
                '<Notice>',
                style: GoogleFonts.gothicA1(
                ...
                child: RaisedButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            TwoChooseScreen(gender: widget.gender),
                      ),
                    );
                  },
